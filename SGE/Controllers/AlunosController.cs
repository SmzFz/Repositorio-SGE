...
namespace SGE.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AlunoId,Matricula,AlunoNome,Email,Celular,Logradouro,Numero,Cidade,Estado,CEP,Senha,DataNascimento,CadAtivo,DataCadastro,CadInativo,TipoUsuarioId,TipoUsuario,UrlFoto")] Aluno aluno, string ConfirmeSenha, IFormFile UrlFoto)
        {
        ...
        public async Task<IActionResult> AlterarFoto(Guid id, IFormFile novaFoto)
        {
            ...
            if (novaFoto != null && novaFoto.Length > 0)
            {
                ...
                var imageBytes = await System.IO.File.ReadAllBytesAsync(filePath);
                var imagemBase64 = Convert.ToBase64String(imageBytes);
                ViewData["Imagem"] = imagemBase64;
